...
def main(args, parser):
	...
	# Update EPOCH CTR
        ...
        train(train_loader, net, criterion, optim, epoch, writer, args)
        validate(val_loader, net, criterion_val, optim, epoch, writer, args)


def train(train_loader, net, criterion, optimizer, curr_epoch, writer, args):
    '''
...
def validate(val_loader, net, criterion, optimizer, curr_epoch, writer, args):
    '''
